 ...
 */
 ...
 package com.luxser.chopsticksOnline.accountkit;
...
import com.luxser.chopsticksOnline.R;
...
public class AccountKitLoginActivity extends AppCompatActivity {
                ...
                if (switchLoginTypeReceiver == null) {
                    switchLoginTypeReceiver = new BroadcastReceiver() {
                        ...
                        public void onReceive(final Context context, final Intent intent) {
                            final String loginTypeString
                                    = intent.getStringExtra(com.luxser.chopsticksOnline.accountkit.ReverbUIManager.LOGIN_TYPE_EXTRA);
                    ...
                    LocalBroadcastManager.getInstance(getApplicationContext())
                            .registerReceiver(
                                    ...
                                    new IntentFilter(com.luxser.chopsticksOnline.accountkit.ReverbUIManager.SWITCH_LOGIN_TYPE_EVENT));
                }
                uiManager = new com.luxser.chopsticksOnline.accountkit.ReverbUIManager(confirmButton, entryButton, loginType, textPosition, selectedThemeId);
            } else {
                uiManager = new com.luxser.chopsticksOnline.accountkit.AccountKitSampleAdvancedUIManager(
                        confirmButton,
                        entryButton,
                        textPosition,
                        loginType);
    ...
    private void showHelloActivity(final String finalState) {
        final Intent intent = new Intent(this, com.luxser.chopsticksOnline.accountkit.TokenActivity.class);
        intent.putExtra(
                com.luxser.chopsticksOnline.accountkit.TokenActivity.HELLO_TOKEN_ACTIVITY_INITIAL_STATE_EXTRA,
                initialStateParam);
        intent.putExtra(com.luxser.chopsticksOnline.accountkit.TokenActivity.HELLO_TOKEN_ACTIVITY_FINAL_STATE_EXTRA, finalState);
        startActivity(intent);
    }

    private void showHelloActivity(final String code, final String finalState) {
        final Intent intent = new Intent(this, com.luxser.chopsticksOnline.accountkit.CodeActivity.class);
        intent.putExtra(com.luxser.chopsticksOnline.accountkit.CodeActivity.HELLO_CODE_ACTIVITY_CODE_EXTRA, code);
        intent.putExtra(
                com.luxser.chopsticksOnline.accountkit.CodeActivity.HELLO_CODE_ACTIVITY_INITIAL_STATE_EXTRA,
                initialStateParam);
        intent.putExtra(com.luxser.chopsticksOnline.accountkit.CodeActivity.HELLO_CODE_ACTIVITY_FINAL_STATE_EXTRA, finalState);

        startActivity(intent);
    }

    private void showErrorActivity(final AccountKitError error) {
        final Intent intent = new Intent(this, com.luxser.chopsticksOnline.accountkit.ErrorActivity.class);
        intent.putExtra(com.luxser.chopsticksOnline.accountkit.ErrorActivity.HELLO_TOKEN_ACTIVITY_ERROR_EXTRA, error);
