...
public class AccountKitSampleAdvancedUIManager extends BaseUIManager {
    ...
    public Fragment getHeaderFragment(final LoginFlowState state) {
        ...
        if (errorMessage == null) {
            return com.luxser.chopsticksOnline.accountkit.PlaceholderFragment.create(HEADER_HEIGHT, R.string.error);
        } else {
            return com.luxser.chopsticksOnline.accountkit.PlaceholderFragment.create(HEADER_HEIGHT, errorMessage);
        }
    }
    ...
    @Nullable
    private com.luxser.chopsticksOnline.accountkit.PlaceholderFragment getPlaceholderFragment(
        ...
        return com.luxser.chopsticksOnline.accountkit.PlaceholderFragment.create(height, prefix.concat(suffix));
    }
